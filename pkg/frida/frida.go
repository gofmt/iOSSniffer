...
func StartFrida(ctx context.Context, wr io.Writer, bundleId, code string) error {
	...
	hScript := C.frida_session_create_script_sync(hSession, C.CString(code), nil, nil, &gErr)
	if gErr != nil {
